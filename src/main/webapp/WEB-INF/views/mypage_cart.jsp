         ...
         <div class="cart-view-area" style="padding-top:0px;">
           <div class="cart-view-table">
             <form action="">
               ...
               <a href="/checkout" class="aa-cart-view-btn">購買する</a>
           </div>
         </div>
       </div>
     </div>
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <ul class="aa-catg-nav">
				<li><a href="/mypageCheckPw">会員情報 修正/脱退</a></li>
                <li><a href="/orderlist">注文/配送照会</a></li>
				<li><a href="/questionList">マイ 問い合わせ履歴</a></li>
              </ul>
            </div>
            <!-- single sidebar -->
          </aside>
